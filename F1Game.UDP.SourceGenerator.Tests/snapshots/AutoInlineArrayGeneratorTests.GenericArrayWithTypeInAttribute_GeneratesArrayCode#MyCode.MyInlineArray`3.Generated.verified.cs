...
/// <summary>
/// Represents an inline array <see cref="MyInlineArray{T, T2, T3}"/> with 69 elements.
	...
	: IEquatable<MyInlineArray<T, T2, T3>>
{
	...
	/// <summary>
	/// Returns a <see cref="Span{double}"/> that represents the elements of this inline array.
	/// </summary>
	/// <returns>
	/// A <see cref="Span{double}"/> of length <c>69</c> that provides mutable access to the elements of the inline array.
	/// </returns>
	public Span<double> AsSpan()
		=> MemoryMarshal.CreateSpan(ref Unsafe.As<MyInlineArray<T, T2, T3>, double>(ref this), 69);

	/// <summary>
	/// Returns a <see cref="ReadOnlySpan{double}"/> that represents the elements of this inline array.
	/// </summary>
	/// <returns>
	/// A <see cref="ReadOnlySpan{double}"/> of length <c>69</c> that provides read-only access to the elements of the inline array.
	/// </returns>
	...
	/// <summary>
	/// Returns an <see cref="IEnumerable{double}"/> that enumerates the elements of this inline array.
	/// </summary>
	/// <returns>
	/// An <see cref="IEnumerable{double}"/> that iterates over the elements of the inline array in order.
	/// </returns>
	...
	/// <summary>
	/// Implicitly converts an array to a <see cref="MyInlineArray{T, T2, T3}"/>.
	...
	/// <summary>
	/// Implicitly converts a <see cref="ReadOnlySpan{double}"/> to a <see cref="MyInlineArray{T, T2, T3}"/>.
	...
	/// <summary>
	/// Implicitly converts a <see cref="Span{double}"/> to a <see cref="MyInlineArray{T, T2, T3}"/>.
	/// Copies up to <c>69</c> elements from the source span; extra elements are ignored, and missing elements are default-initialized.
	/// </summary>
	/// <param name="source">
	/// The source span to copy elements from.
