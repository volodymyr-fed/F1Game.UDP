//HintName: MyCode.MyInlineArray`2.Generated.cs
// <auto-generated/>
#nullable enable
...
/// </summary>
[InlineArray(69)]
partial record struct MyInlineArray<T, T2>
	: IEquatable<MyInlineArray<T, T2>>
{
	...
	public override bool Equals([NotNullWhen(true)] object? obj)
		=> obj is MyInlineArray<T, T2> other && Equals(other);
	...
	public bool Equals(MyInlineArray<T, T2> other)
		=> ((ReadOnlySpan<T2>)this).SequenceEqual((ReadOnlySpan<T2>)other);

	/// <inheritdoc/>
	public override int GetHashCode()
	{
		HashCode hashCode = default;
		ReadOnlySpan<T2> span = this;
		var comparer = EqualityComparer<T2>.Default;

		foreach (ref readonly T2 item in span)
