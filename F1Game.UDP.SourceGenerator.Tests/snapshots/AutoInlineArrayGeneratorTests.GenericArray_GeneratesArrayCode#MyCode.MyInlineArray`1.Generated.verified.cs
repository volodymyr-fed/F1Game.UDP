...
/// <summary>
/// Represents an inline array <see cref="MyInlineArray{T}"/> with 69 elements.
	...
	: IEquatable<MyInlineArray<T>>
{
	...
	/// <summary>
	/// Implicitly converts an array to a <see cref="MyInlineArray{T}"/>.
	...
	/// <summary>
	/// Implicitly converts a <see cref="ReadOnlySpan{T}"/> to a <see cref="MyInlineArray{T}"/>.
	...
	/// <summary>
	/// Implicitly converts a <see cref="Span{T}"/> to a <see cref="MyInlineArray{T}"/>.
	/// Copies up to <c>69</c> elements from the source span; extra elements are ignored, and missing elements are default-initialized.
	/// </summary>
	/// <param name="source">
	/// The source span to copy elements from.
