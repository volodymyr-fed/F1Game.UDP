...
/// <summary>
/// Represents an active aero zone on the track.
/// </summary>
[StructLayout(LayoutKind.Sequential, Pack = 1)]
public readonly record struct ActiveAeroZone() : IByteParsable<ActiveAeroZone>, IByteWritable, ISizeable
{
	...
	static ActiveAeroZone IByteParsable<ActiveAeroZone>.Parse(ref BytesReader reader)
	{
		return new()
		{
